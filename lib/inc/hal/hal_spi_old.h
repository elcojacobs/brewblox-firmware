...
//               SpiSettings::Mode spi_mode, SpiSettings::BitOrder bit_order,
...
//     // , settings.speed(speed_hz)
//     // , settings.queueSize(queue_size)
//     // , settings.ssPin(ss_pin)
//     // , settings.mode(spi_mode)
//     // , settings.bitOrder(bit_order)
//     // , pre_cb(pre)
//     // , post_cb(post)
//     // , onAquire(on_aquire)
